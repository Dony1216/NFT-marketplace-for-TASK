      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-lg">
            Place your bids on {auctionNFTs.length} NFT
            {auctionNFTs.length !== 1 && "s"} before time runs out
          </p>
        </div>

        {/* Search + Sort */}
        <div className="mb-8 p-6 rounded-2xl bg-white/5 border border-purple-500/20">
